...
namespace Vaquinha.Unit.Tests.DomainTests
{
                              ...
                              IClassFixture<CartaoCreditoFixture>
    {
        ...
        [Fact]
        [Trait("Doacao", "Doacao_CorretamentePreenchidos_DoacaoValida")] //Organizar seus testes, agrupar 
        ...
        {           
            ...
            // Assert
            //Assert.True(valido); // versão original
            valido.Should().BeTrue(because: "os campos foram preenchidos corretamente");
            doacao.ErrorMessages.Should().BeEmpty();
        }

        [Fact]
        [Trait("Doacao", "Doacao_UsuarioAceitaPagarComTaxa_DoacaoValida")] //Organizar seus testes, agrupar 
